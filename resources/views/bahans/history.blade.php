...
<div class="max-w-7xl mx-auto p-4 sm:p-6">
    <h1 class="text-2xl font-bold mb-4">📊 Riwayat & Stok Global</h1>

    @if(Auth::user()->role !== 'outlet')
    <div class="mb-6 border-t pt-6">
        <form action="{{ route('bahans.history') }}" method="GET">
            <div class="flex">
                <select name="outlet" id="outlet" onchange="this.form.submit()" class="block w-full md:w-1/3 border rounded p-2 bg-white">
                    <option value="">-- Tampilkan Riwayat Semua Outlet --</option>
