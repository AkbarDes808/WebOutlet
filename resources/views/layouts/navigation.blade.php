                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(Auth::user()->role === 'admin' || Auth::user()->role === 'SPV')
                        ...
                        <x-nav-link
                            ...
                            :active="request()->routeIs('bahans.*')">
                            Inventory
                        </x-nav-link>

                        <x-nav-link
                            :href="route('marinasi.index')"
                            :active="request()->routeIs('marinasi.*')">
                            Produksi
                        </x-nav-link>
                    ...
                    {{-- OUTLET 1 - 6 --}}
                    @if(str_starts_with(Auth::user()->role, 'outlet'))

                        <x-nav-link
                            :href="route('kasir.index')"
                            :active="request()->routeIs('kasir.index')">
                            Kasir
                        </x-nav-link>

                        <x-nav-link
                            :href="route('kasir.history')"
                            :active="request()->routeIs('kasir.history')">
                            Riwayat Pesanan
                        </x-nav-link>

                        <x-nav-link
                            :href="route('shift.history')"
                            :active="request()->routeIs('shift.history')">
                            Riwayat Shift
                        </x-nav-link>
